...
def get_word_score(word, n):
    ...
    for i in word:
        component_1 += SCRABBLE_LETTER_VALUES.get(i,0)

    component_2 = 7*wordlen - 3*(n-wordlen)
    if component_2 < 0:
       component_2 = 1
    
    score = component_1 * component_2
    return score
...
def is_valid_word(word, hand, word_list):
    ...
    if "*" in word:
        ...
        for i in VOWELS:
            predict_word = temp1 + i + temp2
            if predict_word in word_list:
                predict += 1
    ...
    for i in range(calculate_handlen(hand)):
        ...
        if inp == "!!":
            ...
            if is_valid_word(inp, hand, word_list):
                word_score = get_word_score(inp, calculate_handlen(hand))
                total_score += word_score
                print(str(inp), " earned "+ str(word_score) +" points.  Total: ", str(total_score))
    ...
    * Returns the total score for the series of hands
    ...
    for i in range(number_of_hands):
        ...
        if substitute == "yes":
            ...
            replace_letter = replace_letter.lower()
